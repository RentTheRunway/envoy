...
export BAZEL_BUILD_OPTIONS="--strategy=Genrule=standalone --spawn_strategy=standalone \
  ...
  --host_cxxopt=-DENVOY_IGNORE_GLIBCXX_USE_CXX11_ABI_ERROR \
  --host_copt=-DENVOY_IGNORE_GLIBCXX_USE_CXX11_ABI_ERROR \
  --cxxopt=-DENVOY_IGNORE_GLIBCXX_USE_CXX11_ABI_ERROR \
  --copt=-DENVOY_IGNORE_GLIBCXX_USE_CXX11_ABI_ERROR \
